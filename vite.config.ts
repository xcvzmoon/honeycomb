...
export default defineConfig({
  ...
  lint: {
    ...
    rules: {
      ...
      'define-emits-declaration': 'error',
      'define-props-declaration': 'error',
      'define-props-destructuring': 'error',
      'dot-notation': 'error',
      ...
      'unicorn/filename-case': [
        ...
        {
          case: 'kebabCase',
          ignore: [String.raw`^(app|error|app\.config)\..*$`],
        },
      ],
      'func-names': 'error',
      'getter-return': 'error',
      ...
      'no-eq-null': 'error',
      'no-export-in-script-setup': 'error',
      ...
      'no-import-compiler-macros': 'error',
      ...
      'no-required-prop-with-default': 'error',
      ...
      'no-this-in-before-route-enter': 'error',
      ...
      'valid-define-emits': 'error',
      'valid-define-props': 'error',
      'valid-params': 'error',
      'vars-on-top': 'error',
      yoda: 'error',
    },
